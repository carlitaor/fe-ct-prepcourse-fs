...
console.log(dePalabrasAFrase(["Hello", "world!", "Yeah"]))
...
console.log(arrayContiene([5,8,9,6],3)); //false

function agregarNumeros(arrayOfNums) {
   // El parámetro "arrayOfNums" debe ser un arreglo de números.
   // Suma todos los elementos y retorna el resultado.
   // Tu código:
   return arrayOfNums.reduce((contador, num) => contador + num, 0);
}
console.log(agregarNumeros([5,8,6,4,1,2,2]));
